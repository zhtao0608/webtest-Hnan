...
class GenTestData():
    '''
    生成随机测试数据
    create_phone 自动生成手机号
    create_CustName 自动生成客户名称
    Create_Idcard  自动生成身份证号码
    '''
    def create_phone(self):
        ...
        return "1{}{}{}".format(second, third, suffix)         # 拼接手机号

    def create_CustName(self):
    ...
    def getdistrictcode(self):
        '''获取行政区域代码'''
        codelist = []
        file_txt = open(ReadConfig.data_path + 'districtcode.txt')
        lines = file_txt.readlines()  # 逐行读取
        for line in lines:
    ...
    def create_shortCode(self):
        '''自动生成一个集团短号'''
        return random.randrange(610000,699999)

    def create_userPwd(self):
        '''自动生成一个集团短号'''
...
if __name__ == '__main__':
    gen = GenTestData()
    custName = gen.create_CustName()
    print('自动生成客户名称:',custName)
    PhoneNum = gen.create_phone()
    print('自动生成手机号码:',PhoneNum)
    # disrict = gen.getdistrictcode()
    # print(disrict)
    IdCard = gen.Create_Idcard()
    print('自动生成的身份证号码：',IdCard)
    print(gen.create_userPwd())
